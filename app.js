'use strict';
var numCorrect = 0;
function funName(){var name = prompt('IS your name Adam? Yes/No.');
...
funName();
function funFood(){var food = prompt('Do you think i like sushi? Yes/No');
...
funFood();
function funAge(){var age = prompt('Are you older than 30 years old? yes/no');
...
funAge();
function funCoding(){var coding = prompt('Do you like Codiny? Yes/No');
...
funCoding();
function funWorkDone(){var workDone = prompt('Are you almost done with your assignment? Yes/No.');
...
funWorkDone();
var myFaveNum = 20;
function funFaveNum(){for (var i = 0; i < 4; i++) {
...
funFaveNum();
var trueGuess = false;
function funStates(){var statesIlivedIn = ['New York','Florida', 'California', 'Texas'];
